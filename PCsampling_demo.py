...
for predict in predicts:
  for correct in corrects:
    for check_num in checkpoint_num:
      ...
      if sde.lower() == 'vesde':
        ckpt_filename_3h = '/media/lqg/Elements/HSK/SWORD-main/exp_3h_xiaoqiu/checkpoints/checkpoint_{}.pth'.format(check_num[0])
        ckpt_filename_A = '/media/lqg/Elements/HSK/SWORD-main/exp_wavelet_xiaoqiu/checkpoints/checkpoint_{}.pth'.format(check_num[1])
